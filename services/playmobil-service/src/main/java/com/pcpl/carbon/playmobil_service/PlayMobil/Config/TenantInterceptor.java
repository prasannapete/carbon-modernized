...
/**
 * Enforces tenant isolation for every request (mirrors kitkat/shell-analytics):
 * <ul>
 ...
 *       reads of tenant-aware entities (Players, PlayersCopyData, SchemaMetadata) are
 *       automatically scoped to that tenant.</li>
 * </ul>
