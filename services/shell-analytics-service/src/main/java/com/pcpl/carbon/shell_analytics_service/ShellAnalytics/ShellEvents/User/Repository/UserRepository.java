package com.pcpl.carbon.shell_analytics_service.ShellAnalytics.ShellEvents.User.Repository;
...
public interface UserRepository extends PCPLCRUDRepository<User> {
    ...
    Page<User> findAllByIsPlayMobilUserAndIsDeleted(
            Integer isPlayMobilUser,
            Integer isDeleted,
            Pageable pageable
    );
}
